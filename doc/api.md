...
```json
{
  "subscriber_list": {
    ...
    "gov_delivery_id": "123",
    "list_group_id": "f513e107-b2c6-44a6-8d8a-9e6a3ea37b9d",
    "document_type": "",
...
- list_group_id: A UUID that can be provided by an application to group
  together lists for the same resource with different criteria;
